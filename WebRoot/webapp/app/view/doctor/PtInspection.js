...
Ext.define('Wj.view.doctor.PtInspection', {
	extend: 'Ext.panel.Panel',
	alias: 'widget.docptinspection',
	...
	initComponent: function(){
		...
		console.log('-- Wj.view.doctor.PtInspection init.--');
		...
		console.log('-- Wj.view.doctor.PtInspection init over.--');
