Ext.define('Wj.view.examdoctor.ExamPhoto', {
	extend: 'Ext.panel.Panel',
	alias: 'widget.examphoto',
	...
	itemId:'itemid_examphoto',
	title: '影像数据',
	icon: 'icon/iconphoto.png',

	initComponent: function(){

		console.log('-- Wj.view.examdoctor.ExamPhoto init.--');
var gridHeight = 200;
    ...
    },
	{
		...
		itemId:'examphotopanel',
			...
			items: [
				...
				icon: 'icon/look.png',
				itemId: 'lookimg',
				handler: Wj.controller.ExamDoctor.ShowImg
			},
			{
				text: '删除图片',
				icon: 'icon/delete.gif',
				itemId: 'deleteimg',
				handler: Wj.controller.ExamDoctor.ShowDeleteImg
			}]
		}],
		...
		console.log('-- Wj.view.examdoctor.ExamPhoto init over.--');
