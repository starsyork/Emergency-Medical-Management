Ext.define('Wj.view.imgviewer.imageviewer', {
   //extend: 'Ext.container.Container',
     extend:'Ext.window.Window',
	alias: 'widget.surgyimageviewer',
    ...
    initComponent: function () {
        ...
        me.items = [{
            ...
            },
            {
                ...
                listeners: { click: Wj.controller.SurgyDoctor.FormerImg, scope: me }
            },{
                xtype: 'button',
                tooltip:"下一张",
                icon: 'resource/images/imageviewer/nextimg.png',
                listeners: { click: Wj.controller.SurgyDoctor.NextImg, scope: me }
            }]
        }, 
        {
            xtype: 'container',
...
//    FormerImg: function(){
//    	var me = this;
//    	me.getImage().el.dom.src='resource/img/malein1.png';
//    	console.log('Former img');
//    },
//    NextImg: function(){
//    	var me = this;
//    	me.getImage().el.dom.src = 'resource/img/malein2.png';
