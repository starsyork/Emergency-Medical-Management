Ext.define('Wj.view.nurse.DisaReport', {
	extend: 'Ext.panel.Panel',
	alias: 'widget.nursedisareport',
		...
		this.items = [{
			...
			dockedItems: [{
				...
				items: [{
					...
					icon: 'icon/add.png',
					itemId: 'add',
					handler: Wj.controller.Nurse.addDisaReport
				}, {
					text: '删除',
					...
					handler: Wj.controller.Nurse.removeNurseDisaReport
				},
