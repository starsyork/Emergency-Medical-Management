Ext.define('Wj.view.nurse.PtPhoto', {
	extend: 'Ext.panel.Panel',
	alias: 'widget.nurseptphoto',
	...
	initComponent: function(){
		...
		console.log('-- Wj.view.nurse.PtPhoto init.--');
var gridHeight = 200;
    ...
    },
	{
		...
		itemId:'nursephotopanel',
			...
			items: [
				...
				icon: 'icon/look.png',
				itemId: 'lookimg',
				handler: Wj.controller.Nurse.ShowImg
			}]
		}],
		...
		console.log('-- Wj.view.nurse.SurgyPhoto init over.--');
