Ext.define('Wj.view.surgydoctor.SurgyAddPtAdvice', {
	extend: 'Ext.window.Window',
	alias: 'widget.surgyaddptadv',
	...
	initComponent: function(){
		...
		this.items = [{
			...
			items:[{
				...
				name: 'name',
				itemId: 'add_name',
				value: Wj.controller.SurgyDoctor.getPtName(),
				readOnly: true,
				fieldStyle: Wj.consts.css_readOnly
			}, {
				xtype: 'combobox',
				...
				xtype: 'combobox',
				store: 'surgydoctor.SurgyAdvContents',
				autoScroll: true,
				autoSelect: true,
				queryMode: 'remote',
				queryParam: 'term',
...
//				fieldStyle: Wj.consts.css_readOnly,
		...
		this.buttons = [{
			...
			handler: Wj.controller.SurgyDoctor.confirmAddAdvice
		}, {
			text: '重置',
			itemId: 'reset',
			icon: 'icon/reset.png',
