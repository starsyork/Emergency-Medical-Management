...
Ext.define("Ext.ux.grid.Printer", {
    ...
    statics: {
         ...
         */
        printWithData: function(extraData, grid, featureId) {
            ...
            var htmlMarkup = [
                ...
                '<html class="' + Ext.baseCSSPrefix + 'ux-grid-printer">',
                  ...
                  '<tr><td>申请号: ' + extraData.applyNum + '</td>',
                  '<td>收标本: ' + extraData.rcvTime + '</td>',
                  '<td>' + '血检' + '</td></tr>',
                  '</table>',
                  // '<h1>' + this.mainTitle + '</h1>',
                  '<h1 align="center">武警总医院检验报告单</h1>',
                    '<table  class="no-border" border="0" >',
                    '<tr><td>姓名: ' + extraData.name + '</td>',
                    '<td>标识号: ' + extraData.mkNum + '</td>',
                    '<td>性别: ' + extraData.sex + '</td>',
                    '<td>年龄: ' + extraData.age + '</td>',
                    '<td>科别: ' + extraData.kb + '</td>',
                    '<td>床号: ' + extraData.bed + '</td></tr>',
                    '<tr><td>样品号: ' + extraData.name + '</td>',
                    '<td>标本种类: ' + extraData.sampleType + '</td>',
                    '<td>执行: ' + extraData.exec + '</td>',
                    '<td>临床诊断: ' + extraData.diag + '</td>',
                    '<td>申请医师: ' + extraData.applyDoctor + '</td></tr>',
                    '</table>',
                    '<table>',
                      '<tr>',
                        headings,
                    ...
                    '</table>',
                    '<table  class="no-border" border="0" >',
                    '<tr><td>采标本时间: ' + extraData.smpTime + '</td>',
                    '<td>收标本时间: ' + extraData.rcvTime + '</td>',
                    '<td>报告时间: ' + extraData.rptTime + '</td></tr>',
                    '<tr><td>本报告仅对此份申请标本负责</td>',
                    '<td>参考值指成人，儿童结果咨询医生</td>',
                    '<td>检验者: ' + extraData.reporter + '</td>',
                    '<td>核对者: ' + extraData.collater + '</td></tr>',
                    '</table>',
                  '</body>',
                '</html>',
                {
