 ...
 *
 */
Ext.define("Ext.ux.grid.SurgyWardRecPrinter", {
    ...
    statics: {
        ...
        printWithData: function(extraData, grid, featureId) {
           ...
           console.log('this.stylesheetPath:',this.stylesheetPath);
			...
			var nowDate =  Ext.util.Format.date(new Date(),'Y/m/d g:i:s A');
            ...
            var htmlMarkup = [
                ...
                '<html class="' + Ext.baseCSSPrefix + 'ux-grid-printer">',
                  ...
                  '<h1 align="center">武警总医院查房记录报告单</h1>',
                  	'<br></br>',
                    '<table  class="no-border" border="0" >',
                    '<tr><td>姓名: ' + extraData.name + '</td>',
                    '<td>标识号: ' + extraData.id + '</td>',
                    ...
                    '</table>',
                    '<table  class="no-border" border="0" >',
                    '<td>打印时间: ' + nowDate + '</td></tr>',
                    '<tr><td>本报告仅对此份记录负责</td>',
                    '<td>记录者签字: '  + '</td>',
                    '<td>核对者签字: ' + '</td></tr>',
                    '</table>',
                  '</body>',
